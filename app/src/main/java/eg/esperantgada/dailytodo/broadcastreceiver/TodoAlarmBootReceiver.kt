    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        if (intent != null) {
            if (intent.action == "android.intent.action.BOOT_COMPLETED") {
                ...
                val tuesdayWednesdayThursday: List<String> =
                    listOf("Tuesday", "Wednesday", "Thursday")
                val tuesdayWednesdayFriday: List<String> = listOf("Tuesday", "Wednesday", "Friday")
                val tuesdayWednesdaySaturday: List<String> =
                    listOf("Tuesday", "Wednesday", "Saturday")
                val tuesdayWednesdaySunday: List<String> = listOf("Tuesday", "Wednesday", "Sunday")
                val wednesdayThursdayFriday: List<String> =
                    listOf("Wednesday", "Thursday", "Friday")
                val wednesdayThursdaySaturday: List<String> =
                    listOf("Wednesday", "Thursday", "Saturday")
                val wednesdayThursdaySunday: List<String> =
                    listOf("Wednesday", "Thursday", "Sunday")
                    ...
                    if (id >= 0) {
                        if (dayList != null) {
                            when (dayList.size) {
                                ...
                                6 -> {
                                    if (mondayTuesdayWednesdayThursdayFridaySaturday.containsAll(
                                            dayList)
                                    ) {
                                        if (day == Calendar.MONDAY || day == Calendar.TUESDAY ||
                                            day == Calendar.WEDNESDAY || day == Calendar.THURSDAY ||
                                    ...
                                    if (mondayTuesdayWednesdayThursdayFridaySunday.containsAll(
                                            dayList)
                                    ) {
                                        if (day == Calendar.MONDAY || day == Calendar.TUESDAY ||
                                            day == Calendar.WEDNESDAY || day == Calendar.THURSDAY ||
                                    ...
                                    if (tuesdayWednesdayThursdayFridaySaturdaySunday.containsAll(
                                            dayList)
                                    ) {
                                        if (day == Calendar.TUESDAY || day == Calendar.WEDNESDAY ||
                                            day == Calendar.THURSDAY || day == Calendar.FRIDAY ||
